...
#        self.thread.finished.connect(self.updateUI)
    ...
    def fillUI(self):
        ...
        self.cpuBox.addWidget(QLabel(color(bold("CPU"), COLOR_HEADER)), 0, 0, 1, 3, Qt.AlignCenter)
        ...
        for i in range(0, self.sys.cpus):
            ...
            self.cpuBox.addWidget(self.cpuBar[i], i + 1, 1, 1, 1, Qt.AlignCenter)
            self.cpuBox.addWidget(self.cpu[i], i + 1, 2, 1, 1, Qt.AlignRight)
